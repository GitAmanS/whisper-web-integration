...
export function TranscribeButton(props: Props): JSX.Element {
    ...
    return (
        <button
            ...
            className='text-white w-auto h-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium text-sm  py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center'
        >
            {isModelLoading ? (
